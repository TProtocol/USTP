...
const { developmentChains, AddressConfig, iUSTPId } = require("../../common/network-config")
...
module.exports = async ({ getNamedAccounts, deployments }) => {
	...
	const iUSTPArgs = [config.adminAddress, config.rUSTPAddess]
...
module.exports.tags = ["iUSTP-test", "testnet"]
